...
export default function ProductionGridA({ performances, setSelectedPerformance }) {
    ...
    return (
        <Grid container spacing={3} className="performances">
            ...
            <Grid item xs={4} className="no-padd-btm fullHeight">
                <Grid container direction='column' spacing={3} className="fullHeight">
                    <Grid item xs={4}>
                        <Performance boxType="3" performance={performances[4]} setSelectedPerformance={setSelectedPerformance}/>
                    </Grid>
                    <Grid item xs={8}>
                        <Performance boxType="2" performance={performances[5]} setSelectedPerformance={setSelectedPerformance}/>
                    </Grid>
                </Grid>
            </Grid>
        </Grid>
